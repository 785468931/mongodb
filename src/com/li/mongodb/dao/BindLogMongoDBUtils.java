...
public class BindLogMongoDBUtils {

	private MongoClient mongoClient = Config.mongoClient;
	private MongoDatabase db = Config.db;
	private MongoCollection collection = db.getCollection("bindLog");
	public static void main(String[] args) {

		new BindLogMongoDBUtils().bindLogListQuery(0, 2);

//		 new BindLogMongoDBUtils().bindLogInsert("13421747372", "1380099920000",
//		 "0000", "success",
//		 "<ErrorMsgContent><errorCode>0000</errorCode><errorMessage>交易成功</errorMessage></ErrorMsgContent>",
//		 "<ErrorMsgContent><errorCode>0000</errorCode><errorMessage>交易成功</errorMessage></ErrorMsgContent>",
//		 "success","success");
		
//		long total = new bindLogMongoDBUtils().bindLogListQuerySize();
//		System.out.println(total);
		
//		System.out.println(new bindLogMongoDBUtils().bindLogDelete("1380099920000"));
	...
	public String bindLogListQuery(int page, int total) {
		if (page <= 0) {
			page = 1;
		}
		page = (page - 1) * total;
		...
		// true}};
		long totalCount=(long)bindLogListQuerySize(); 
...
//			System.out.println(user.toJson());
	...
	public long bindLogListQuerySize() {
	 ...
	 */
	public void bindLogInsert(String phoneNo, String orderNo, String errorCode,
	...
	public String bindLogWhereQuery(int page, int total,String phoneNo) {
		if (page <= 0) {
			page = 1;
		}
		page = (page - 1) * total;
...
//			System.out.println(user.toJson());
	...
	public long bindLogDelete(String orderNo) {
