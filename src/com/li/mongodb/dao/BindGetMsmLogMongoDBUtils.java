...
public class BindGetMsmLogMongoDBUtils {

	private MongoClient mongoClient = Config.mongoClient;
	private MongoDatabase db = Config.db;
	private MongoCollection collection = db.getCollection("bindGetMsmLog");
	public static void main(String[] args) {

		new BindGetMsmLogMongoDBUtils().bindGetMsmLogListQuery(0, 2);

//		 new BindGetMsmLogMongoDBUtils().bindGetMsmLogInsert("13421747372", "1380099920000",
//		 "0000", "success",
//		 "<ErrorMsgContent><errorCode>0000</errorCode><errorMessage>交易成功</errorMessage></ErrorMsgContent>",
//		 "<ErrorMsgContent><errorCode>0000</errorCode><errorMessage>交易成功</errorMessage></ErrorMsgContent>",
//		 "success","success");
		
//		long total = new bindGetMsmLogMongoDBUtils().bindGetMsmLogListQuerySize();
//		System.out.println(total);
		
//		System.out.println(new bindGetMsmLogMongoDBUtils().bindGetMsmLogDelete("1380099920000"));
	...
	public String bindGetMsmLogListQuery(int page, int total) {
		if (page <= 0) {
			page = 1;
		}
		page = (page - 1) * total;
		...
		long totalCount=(long)bindGetMsmLogListQuerySize(); 
	...
	public long bindGetMsmLogListQuerySize() {
		MongoCollection collection = db.getCollection("bindGetMsmLog");
	 ...
	 */
	public void bindGetMsmLogInsert(String phoneNo, String orderNo, String errorCode,
	...
	public String bindGetMsmWhereQuery(int page, int total,String phoneNo) {
		if (page <= 0) {
			page = 1;
		}
		page = (page - 1) * total;
...
//			System.out.println(user.toJson());
	...
	public long bindGetMsmLogDelete(String orderNo) {
